...
using ResiliencePatterns.DotNet.Domain.Entities;
using ResiliencePatterns.DotNet.Infra.EntityTypeConfigurations;

namespace ResiliencePatterns.DotNet.Infra
{
    public class ResiliencePatternsDotNetDbContext : DbContext
    {
         #region Tables
        ...
        public ResiliencePatternsDotNetDbContext(DbContextOptions<ResiliencePatternsDotNetDbContext> options) : base(options)
        {
            Database.Migrate();
        }
